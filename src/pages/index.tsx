  ...
  return (
    <>
      <main className="flex h-screen flex-col items-center justify-center overflow-y-hidden bg-famous-black px-3">
        <p className={`${modak.className} text-8xl text-pink-400`}>Gather</p>
        ...
        <div className="flex items-center justify-center gap-6 text-famous-black">
          {user.isSignedIn ? (
            <Link href={"/home"}>
            ...
            <SignInButton mode="modal" redirectUrl="/home">
              <button className="prevent-select rounded-full bg-pink-400 px-10 py-2 text-xl font-semibold transition-shadow duration-300 hover:shadow-md hover:shadow-pink-400/40">
                Get started
              </button>
            </SignInButton>
          )}
          <Link
            href={"/"}
            className="flex items-center justify-center gap-2 rounded-full bg-famous-black px-10 py-2 text-lg font-semibold text-pink-400 ring-1 ring-pink-400 duration-300 hover:shadow-md hover:shadow-pink-400/40"
          >
            How it works
            <span>
