  ...
  return (
    <main className="flex flex-col items-center justify-center bg-famous-black px-3">
      <section className="mt-32">
        ...
        <div className="mx-auto flex max-w-xs flex-col items-center justify-between gap-4 text-famous-black md:max-w-md md:flex-row">
          {user.isSignedIn ? (
            <Link href={"/home"}>
          ...
          <Link
            href="#how-it-works"
            className="flex items-center justify-center rounded-full bg-famous-black px-10 py-2 text-lg font-semibold text-pink-400 ring-1 ring-pink-400 duration-300 hover:shadow-md hover:shadow-pink-400/40"
            scroll={false}
          >
            How it works
          </Link>
